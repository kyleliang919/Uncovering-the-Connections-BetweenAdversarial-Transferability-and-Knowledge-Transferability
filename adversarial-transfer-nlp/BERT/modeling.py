...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None, speaker_ids=None, inputs_embeds=None):
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, speaker_ids=None,
                output_all_encoded_layers=True, head_mask=None, inputs_embeds=None):
        ...
        embedding_output = self.embeddings(input_ids, token_type_ids, speaker_ids, inputs_embeds)
...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None, head_mask=None, inputs_embeds=None):
